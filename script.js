...
const tests = {
  binet: {
    ...
    measures: "الحكم العملي، تذكّر الأرقام، المفردات، التشابهات، كشف السخافات.",
    minAge: 6,
    maxAge: 10,
    kind: "quiz",
    questions: [
      {
        type: "حكم عملي",
        q: "لو وجدتَ ظرفاً مُغلقاً عليه عنوان وطابع بريدي في الشارع، ماذا تفعل؟",
        options: ["تفتحه لترى ما بداخله", "تضعه في أقرب صندوق بريد", "تتركه مكانه"],
        answer: "تضعه في أقرب صندوق بريد",
      },
      {
        type: "كشف السخافة",
        q: "ما الخطأ في هذه الجملة: 'كان الجو حاراً جداً، فارتدى سامي معطفه الثقيل'؟",
        options: ["لا يوجد خطأ", "الجو الحار لا يستدعي ارتداء معطف ثقيل", "المعطف لم يكن ثقيلاً"],
        answer: "الجو الحار لا يستدعي ارتداء معطف ثقيل",
      },
      {
        type: "تذكّر الأرقام",
        q: "استمع لهذه الأرقام: 6 - 2 - 8 - 4. ما الرقم الثالث؟",
        options: ["2", "8", "4"],
        answer: "8",
      },
      {
        type: "مفردات",
        q: "ما معنى كلمة 'شجاع'؟",
        options: ["من يخاف كثيراً", "من لا يهاب الخطر", "من يتهرّب من المواقف"],
        answer: "من لا يهاب الخطر",
      },
      {
        type: "تشابه",
        q: "في أي شيء تتشابه الشمس والقمر؟",
        options: ["كلاهما يضيء السماء", "كلاهما ساخن جداً", "كلاهما أصفر دائماً"],
        answer: "كلاهما يضيء السماء",
      },
      {
        type: "حكم اجتماعي",
        q: "اكتشفتَ خطأً ارتكبتَه بدون قصد. ما الأصح أن تفعل؟",
        options: ["إخفاؤه حتى لا يعرف أحد", "الاعتراف به ومحاولة تصحيحه", "إلقاء اللوم على غيرك"],
        answer: "الاعتراف به ومحاولة تصحيحه",
      },
    ],
  },
  ...
  piaget: {
    ...
    measures: "حفظ العدد والسائل، الشمول الصنفي، الاسترداد العكسي، الترتيب التسلسلي، أخذ منظور الآخر.",
    minAge: 6,
    maxAge: 12,
    kind: "quiz",
    questions: [
      {
        type: "حفظ العدد",
        q: "صفّت منى 6 حبّات في صف قصير متقارب، ثم باعدت بينها فأصبح الصف أطول. كم عدد الحبات الآن؟",
        options: ["أكثر من 6", "6 كما هي", "أقل من 6"],
        answer: "6 كما هي",
      },
      {
        type: "شمول صنفي",
        q: "في حديقة فيها 7 ورود و3 أقحوان — هل الزهور أكثر أم الورود؟",
        options: ["الورود أكثر", "الزهور أكثر", "هما متساويتان"],
        answer: "الزهور أكثر",
      },
      {
        type: "حفظ السائل",
        q: "سُكب نفس الكمية من العصير في كوبٍ طويل رفيع وكوبٍ قصير عريض. أيهما أكثر عصيراً؟",
        options: ["الطويل الرفيع لأنه أعلى", "القصير العريض لأنه أوسع", "هما متساويان لأن الكمية لم تتغير"],
        answer: "هما متساويان لأن الكمية لم تتغير",
      },
      {
        type: "الاسترداد العكسي",
        q: "إذا كانت 4 + 5 = 9، فكم يساوي 9 − 5 دون إجراء حساب جديد؟",
        options: ["3", "4", "5"],
        answer: "4",
      },
      {
        type: "ترتيب تسلسلي",
        q: "لديك أعواد بأطوال مختلفة. ما أفضل طريقة لترتيبها بشكل منطقي؟",
        options: ["حسب لونها", "من الأقصر إلى الأطول", "بشكل عشوائي"],
        answer: "من الأقصر إلى الأطول",
      },
      {
        type: "أخذ منظور الآخر",
        q: "وقفتَ أمام مرآة ورفعتَ يدك اليُمنى. أي يد تراها مرتفعةً في المرآة؟",
        options: ["اليُمنى", "اليُسرى", "كلتاهما في آنٍ واحد"],
        answer: "اليُسرى",
      },
    ],
  },
  ...
  terman: {
    ...
    measures: "تشابهات، قياسات لفظية، مفردات، فهم، استدلال كمي، متتاليات.",
    minAge: 16,
    maxAge: null,
    kind: "quiz",
    questions: [
      {
        type: "تشابه",
        q: "في أي شيء تتشابه الشجرة والزهرة؟",
        options: ["كلتاهما بلا جذور", "كلتاهما نباتات", "كلتاهما لا تحتاج إلى ماء"],
        answer: "كلتاهما نباتات",
      },
      {
        type: "قياس لفظي",
        q: "مكتبة : كتب — مثل — مستودع : ؟",
        options: ["زوار", "بضائع", "مبانٍ"],
        answer: "بضائع",
      },
      {
        type: "مفردات",
        q: "الكلمة الأقرب معنىً لـ'متحمّس':",
        options: ["خامل ومتردد", "مندفع بحماس نحو هدف", "هادئ ومتأمل"],
        answer: "مندفع بحماس نحو هدف",
      },
      {
        type: "فهم",
        q: "لماذا تُبنى السجون في المجتمع؟",
        options: ["لإيذاء المخالفين فقط", "لحماية المجتمع وردع الجريمة", "لتوفير مكان للراحة"],
        answer: "لحماية المجتمع وردع الجريمة",
      },
      {
        type: "استدلال كمي",
        q: "أيهما أثقل وزناً: كيلوغرام من القطن أم كيلوغرام من الحديد؟",
        options: ["كيلو الحديد أثقل", "كيلو القطن أثقل", "هما متساويان في الوزن"],
        answer: "هما متساويان في الوزن",
      },
      {
        type: "متتالية",
        q: "أكمل: 2، 6، 18، 54، ؟",
  ...
  wechsler: {
    ...
    measures: "تشابهات، مدى الأرقام، فهم اجتماعي، مفردات، حساب ذهني، تشابهات مجردة.",
    minAge: 13,
    maxAge: null,
    kind: "quiz",
    questions: [
      {
        type: "تشابهات",
        q: "بأي طريقة يتشابه الغضب والسعادة؟",
        options: ["كلاهما مشاعر إنسانية", "كلاهما إيجابيان دائماً", "لا يتشابهان أبداً"],
        answer: "كلاهما مشاعر إنسانية",
      },
      {
        type: "مدى الأرقام",
        q: "أعِد هذه الأرقام بالترتيب نفسه تماماً: 5 - 8 - 2 - 6",
        options: ["5-8-2-6", "6-2-8-5", "5-2-8-6"],
        answer: "5-8-2-6",
      },
      {
        type: "فهم اجتماعي",
        q: "لماذا يدفع المواطنون ضرائب للدولة؟",
        options: ["لأن القانون يُلزم بذلك فقط دون سبب", "لأنها تموّل الخدمات العامة كالصحة والتعليم", "لا يعرف أحد السبب الحقيقي"],
        answer: "لأنها تموّل الخدمات العامة كالصحة والتعليم",
      },
      {
        type: "مفردات",
        q: "ما معنى كلمة 'فصيح'؟",
        options: ["صامت وخجول", "يتكلم بوضوح وبلاغة", "سريع في الحركة"],
        answer: "يتكلم بوضوح وبلاغة",
      },
      {
        type: "حساب ذهني",
        q: "اشترت سارة 4 كتب بـ18 جنيهاً كلٌّ منها. كم دفعت في المجموع؟",
        options: ["64", "72", "80"],
        answer: "72",
      },
      {
        type: "تشابهات مجردة",
        q: "بأي طريقة تتشابه القصيدة والمعزوفة الموسيقية؟",
        options: ["كلتاهما تُكتبان فقط بالكلمات", "كلتاهما شكل من أشكال التعبير الفني", "لا توجد أوجه تشابه بينهما"],
        answer: "كلتاهما شكل من أشكال التعبير الفني",
      },
    ],
  },
  ...
  spearman: {
    ...
    measures: "استدلال ارتباطي نقي، قياسات لفظية، أنماط عددية، استنتاج منطقي.",
    minAge: 11,
    maxAge: null,
    kind: "quiz",
    questions: [
      {
        type: "قياس لفظي",
        q: "معلم : فصل دراسي — مثل — طبيب : ؟",
        options: ["دواء", "عيادة", "مريض"],
        answer: "عيادة",
      },
      {
        type: "استدلال ترتيبي",
        q: "إذا كانت ○ أكبر من □، و□ أكبر من △، فأيهما أكبر: ○ أم △؟",
        options: ["△ أكبر", "○ أكبر", "هما متساويان"],
        answer: "○ أكبر",
      },
      {
        type: "متتالية عددية",
      ...
      {
        type: "الغريب",
        q: "أيهم لا ينتمي للمجموعة: شمس — قمر — نجم — قلم؟",
        options: ["شمس", "نجم", "قلم"],
        answer: "قلم",
      },
      {
        type: "قياس متعاكس",
        q: "حار : بارد — مثل — سريع : ؟",
        options: ["صغير", "بطيء", "ثقيل"],
        answer: "بطيء",
      },
      {
        type: "متتالية أولية",
        q: "أكمل: 2، 3، 5، 7، 11، 13، ؟",
        options: ["14", "15", "17"],
        answer: "17",
      },
    ],
  ...
  cattell: {
    ...
    measures: "أنماط غير لفظية خالصة، تصنيف رمزي، استدلال مجرد مستقل عن اللغة والثقافة.",
    minAge: 14,
    maxAge: null,
    kind: "quiz",
    questions: [
      ...
      {
        type: "الغريب الرمزي",
        q: "أيهم مختلف عن الباقين؟ 🔺 🔺 🔺 🔵",
        options: ["🔺 (الأول)", "🔺 (الثاني)", "🔵 (الرابع)"],
        answer: "🔵 (الرابع)",
      },
      {
        type: "متتالية بالفروق",
        q: "أكمل: 1، 2، 4، 7، 11، ؟  (الفروق: 1، 2، 3، 4، ...)",
        options: ["14", "16", "15"],
        answer: "16",
      },
      {
      ...
      {
        type: "مصفوفة نسبية",
        q: "إذا كان ◼◼ يُقابله ◼ في العمود التالي، فـ ◼◼◼◼ يُقابله:",
        options: ["◼", "◼◼", "◼◼◼"],
        answer: "◼◼",
      },
      {
        type: "تصنيف شكلي",
        q: "أيهم لا ينتمي للمجموعة: △ △ △ □",
        options: ["△", "□", "كلها متشابهة"],
        answer: "□",
      },
    ],
  },
  ...
  sternberg: {
    ...
    measures: "تحليلي + عملي + إبداعي وفق النظرية الثلاثية للذكاء.",
    minAge: 15,
    maxAge: null,
    kind: "quiz",
    questions: [
      {
        type: "تحليلي",
        q: "حُلّت مسألة بطريقتين: الأولى أسرع والثانية أدق. أيهما تختار إذا كان الوقت كافياً؟",
        options: ["الأسرع دائماً بغض النظر", "الأدق لأن الجودة أهم حين يتوفر الوقت", "لا فرق بينهما"],
        answer: "الأدق لأن الجودة أهم حين يتوفر الوقت",
      },
      {
        type: "تحليلي",
        q: "الحجة التالية: 'كل الطيور تطير، والنعامة طائر، إذن النعامة تطير'. أين الخلل المنطقي؟",
        options: ["لا خلل، الاستنتاج صحيح", "المقدمة الأولى خاطئة لأن بعض الطيور لا تطير", "النعامة ليست طائراً أصلاً"],
        answer: "المقدمة الأولى خاطئة لأن بعض الطيور لا تطير",
      },
      {
        type: "عملي",
        q: "صديقك يعرض عليك مشكلة معقدة. ما أول خطوة عملية صحيحة؟",
        options: ["تقديم الحل فوراً قبل سماع التفاصيل", "الاستماع الكامل لفهم المشكلة قبل أي رأي", "إحالته لشخص آخر مباشرة"],
        answer: "الاستماع الكامل لفهم المشكلة قبل أي رأي",
      },
      {
        type: "عملي",
        q: "لاحظتَ أن طريقة عمل فريقك تتسبب في أخطاء متكررة. ما الأنسب؟",
        options: ["الصمت لتجنب الإحراج", "اقتراح تحسين بأسلوب بنّاء", "الانسحاب من الفريق فوراً"],
        answer: "اقتراح تحسين بأسلوب بنّاء",
      },
      {
        type: "إبداعي",
        q: "طُلب منك تصميم لعبة جديدة لم يصنعها أحد. أفضل نقطة بداية:",
        options: ["نسخ لعبة موجودة وتغيير اسمها", "دراسة احتياجات اللاعبين ثم ابتكار فكرة أصيلة", "رفض المهمة لأنها صعبة"],
        answer: "دراسة احتياجات اللاعبين ثم ابتكار فكرة أصيلة",
      },
      {
        type: "إبداعي",
        q: "أمامك مشكلة لم يجد لها أحد حلاً من قبل. أفضل نهج:",
        options: ["تطبيق نفس الحلول التقليدية القديمة", "إعادة صياغة المشكلة من زاوية مختلفة كلياً", "انتظار أن يحلّها شخص آخر"],
        answer: "إعادة صياغة المشكلة من زاوية مختلفة كلياً",
      },
    ],
  },
  ...
  gardner: {
    ...
    measures: "تحديد نمط الذكاءات الثمانية الأقرب لشخصيتك وطريقة تفكيرك.",
    minAge: 10,
    maxAge: null,
    kind: "inventory",
    questions: [
      { dim: "الذكاء اللغوي", q: "أستمتع بالألعاب اللغوية والكلمات المتقاطعة، وأتذكر ما أقرأه بسهولة أكثر من غيري." },
      { dim: "الذكاء المنطقي-الرياضي", q: "أُفكّر بشكل منهجي وأستمتع باكتشاف الأنماط والعلاقات بين الأعداد والأفكار." },
      { dim: "الذكاء البصري-المكاني", q: "أجد سهولة في قراءة الخرائط والمخططات، وأتخيّل الأشياء بوضوح في ثلاثة أبعاد." },
      { dim: "الذكاء الموسيقي", q: "ألاحظ الإيقاعات والأنماط الموسيقية بسرعة، وتؤثر فيّ الموسيقى بطريقة مختلفة عن الآخرين." },
      { dim: "الذكاء الحركي-الجسدي", q: "أتعلم المهارات الجسدية بسرعة، وأُعبّر عن أفكاري أحياناً من خلال الحركة والإيماء." },
      { dim: "الذكاء الاجتماعي", q: "أفهم مشاعر الآخرين ودوافعهم بسهولة، وأستمتع بالعمل ضمن مجموعات والتواصل مع الناس." },
      { dim: "الذكاء الذاتي", q: "أعرف نقاط قوتي وضعفي جيداً، وأُفضّل التأمل الداخلي والعمل باستقلالية." },
      { dim: "الذكاء الطبيعي", q: "أُميّز بين أنواع النباتات والحيوانات بسهولة، وأستمتع بملاحظة أنماط الطبيعة والبيئة من حولي." },
    ],
  },
};
...
function buildRangeMeaningTable() {
      ...
      return `
        <div class="meaning-card">
          <div class="meaning-card-header">
            <span class="meaning-card-range">${r.from}–${r.to}%</span>
            <span class="meaning-pill ${levelClass(r.level)}">${r.level}</span>
          </div>
          <div class="meaning-card-body">${escapeHtml(desc.meaning)}</div>
        </div>
      `;
    })
    .join("");
  ...
  return `
    <table class="meaning-table desktop-only">
      <thead>
        <tr>
          <th>النطاق</th>
          <th>المستوى</th>
    ...
    <div class="meaning-cards mobile-only">${cards}</div>
  `;
}
...
function buildRawScoreMeaningTable(totalQuestions) {
  ...
  const cards = rows
    .map(
      (r) => `
        <div class="meaning-card">
          <div class="meaning-card-header">
            <span class="meaning-card-score">${r.s}/${totalQuestions}</span>
            <span class="meaning-pill ${levelClass(r.lvl)}">${r.lvl}</span>
          </div>
          <div class="meaning-card-meta">النسبة: ${r.perc}%</div>
          <div class="meaning-card-body">${escapeHtml(r.meaning)}</div>
        </div>
      `,
    )
    .join("");
  ...
  return `
    ...
    <div class="meaning-cards mobile-only raw-score-cards">${cards}</div>
  `;
}
